...
int main()
{
	...
	// 加载着色器
	Shader pbrShader("../assets/shader/pbr.vs", "../assets/shader/pbr.fs");
	Shader depthShader("../assets/shader/depth.vs", "../assets/shader/depth.fs", "../assets/shader/depth.gs");
	Shader equirectangularToCubemapShader("../assets/shader/cubemap.vs", "../assets/shader/equirectangular_to_cubemap.fs");
	Shader irradianceShader("../assets/shader/cubemap.vs", "../assets/shader/irradiance.fs");
	Shader prefilterShader("../assets/shader/cubemap.vs", "../assets/shader/prefilter.fs");
	Shader brdfShader("../assets/shader/brdf.vs", "../assets/shader/brdf.fs");
	...
	unsigned int envCubemap = loadCubemap("../assets/skybox/modern_evening_street_4k.hdr", equirectangularToCubemapShader);
	...
	Model* resBookShelf = getModelResource("../assets/model/book_shelf/scene.gltf", true);
	Model* resBook1 = getModelResource("../assets/model/book1/scene.gltf", true);
	Model* resBook2 = getModelResource("../assets/model/book2/scene.gltf", true);
	Model* resBooks1 = getModelResource("../assets/model/books1/scene.gltf", true);
	Model* resBooks2 = getModelResource("../assets/model/books2/scene.gltf", true);
	Model* resBook3 = getModelResource("../assets/model/book3/scene.gltf", true);

	Model* resLight = getModelResource("../assets/model/ceiling_light/scene.gltf", true);
	Model* resTable = getModelResource("../assets/model/table/scene.gltf", true);
	Model* resChair = getModelResource("../assets/model/chair/scene.gltf", true);
	Model* resSofa1 = getModelResource("../assets/model/sofa/scene.gltf", true);
	Model* resSofa2 = getModelResource("../assets/model/sofa2/scene.gltf", true);
	Model* resDoor = getModelResource("../assets/model/door/scene.gltf", true);
	Model* resWindow = getModelResource("../assets/model/glass_window/scene.gltf", true);

	Model* resBookShelf2 = getModelResource("../assets/model/book_shelf2/scene.gltf", true);
	Model* resBookcase1 = getModelResource("../assets/model/bookcase/scene.gltf", true);
	Model* resBookcase2 = getModelResource("../assets/model/bookcase2/scene.gltf", true);

	Model* resfurniture = getModelResource("../assets/model/furniture/scene.gltf", true);
	Model* respicture1 = getModelResource("../assets/model/picture1/scene.gltf", true);
	Model* respicture2 = getModelResource("../assets/model/picture2/scene.gltf", true);
	Model* resclock = getModelResource("../assets/model/clock/scene.gltf", true);
	Model* resplant2 = getModelResource("../assets/model/plant2/scene.gltf", true);
	Model* resbookshelf3 = getModelResource("../assets/model/bookshelf3/scene.gltf", true);
	...
	unsigned int floorAlbedo = loadTexture("../assets/texture/floor/basecolor.png");
	unsigned int floorNormal = loadTexture("../assets/texture/floor/normal.png");
	unsigned int floorheight = loadTexture("../assets/texture/floor/height.png");
	unsigned int floorRoughness = loadTexture("../assets/texture/floor/roughness.png");
	unsigned int floorAO = loadTexture("../assets/texture/floor/ao.png");

	unsigned int marblealbedo = loadTexture("../assets/texture/marble/basecolor.png");
	unsigned int marblenormal = loadTexture("../assets/texture/marble/normal.png");
	unsigned int marbleheight = loadTexture("../assets/texture/marble/height.png");
	unsigned int marbleroughness = loadTexture("../assets/texture/marble/roughness.png");

	unsigned int wallalbedo = loadTexture("../assets/texture/wall/basecolor.png");
	unsigned int wallnormal = loadTexture("../assets/texture/wall/normal.png");
	unsigned int wallheight = loadTexture("../assets/texture/wall/height.png");
	unsigned int wallroughness = loadTexture("../assets/texture/wall/roughness.png");
	unsigned int wallao = loadTexture("../assets/texture/wall/ao.png");

	unsigned int ceilingalbedo = loadTexture("../assets/texture/ceiling/basecolor.jpg");
	unsigned int ceilingnormal = loadTexture("../assets/texture/ceiling/normal.jpg");
	unsigned int ceilingheight = loadTexture("../assets/texture/ceiling/height.png");
	unsigned int ceilingroughness = loadTexture("../assets/texture/ceiling/roughness.jpg");
	unsigned int ceilingao = loadTexture("../assets/texture/ceiling/ao.jpg");

	unsigned int tilesalbedo = loadTexture("../assets/texture/tiles/basecolor.jpg");
	unsigned int tilesnormal = loadTexture("../assets/texture/tiles/normal.jpg");
	unsigned int tilesheight = loadTexture("../assets/texture/tiles/height.png");
	unsigned int tilesroughness = loadTexture("../assets/texture/tiles/roughness.jpg");
	unsigned int tilesao = loadTexture("../assets/texture/tiles/ao.jpg");
