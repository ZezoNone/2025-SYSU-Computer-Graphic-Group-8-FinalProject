...
int main()
{
	...
	unsigned int envCubemap = loadCubemap("skybox/street/street.hdr", equirectangularToCubemapShader);
	...
	Model* resBookShelf = getModelResource("model/book_shelf/scene.gltf", true);
	Model* resBook1 = getModelResource("model/book1/scene.gltf", true);
	Model* resBook2 = getModelResource("model/book2/scene.gltf", true);
	Model* resBooks1 = getModelResource("model/books1/scene.gltf", true);
	Model* resBooks2 = getModelResource("model/books2/scene.gltf", true);
	Model* resBook3 = getModelResource("model/book3/scene.gltf", true);

	Model* resLight = getModelResource("model/ceiling_light/scene.gltf", true);
	Model* resTable = getModelResource("model/table/scene.gltf", true);
	Model* resChair = getModelResource("model/chair/scene.gltf", true);
	Model* resSofa1 = getModelResource("model/sofa/scene.gltf", true);
	Model* resSofa2 = getModelResource("model/sofa2/scene.gltf", true);
	Model* resDoor = getModelResource("model/door/scene.gltf", true);
	Model* resWindow = getModelResource("model/glass_window/scene.gltf", true);

	Model* resBookShelf2 = getModelResource("model/book_shelf2/scene.gltf", true);
	Model* resBookcase1 = getModelResource("model/bookcase/scene.gltf", true);
	Model* resBookcase2 = getModelResource("model/bookcase2/scene.gltf", true);

	Model* resfurniture = getModelResource("model/furniture/scene.gltf", true);
	Model* respicture1 = getModelResource("model/picture1/scene.gltf", true);
	Model* respicture2 = getModelResource("model/picture2/scene.gltf", true);
	Model* resclock = getModelResource("model/clock/scene.gltf", true);
	Model* resplant2 = getModelResource("model/plant2/scene.gltf", true);
	Model* resbookshelf3 = getModelResource("model/bookshelf3/scene.gltf", true);
	...
	unsigned int floorAlbedo = loadTexture("texture/floor/basecolor.png");
	unsigned int floorNormal = loadTexture("texture/floor/normal.png");
	unsigned int floorheight = loadTexture("texture/floor/height.png");
	unsigned int floorRoughness = loadTexture("texture/floor/roughness.png");
	unsigned int floorAO = loadTexture("texture/floor/ao.png");

	unsigned int marblealbedo = loadTexture("texture/marble/basecolor.png");
	unsigned int marblenormal = loadTexture("texture/marble/normal.png");
	unsigned int marbleheight = loadTexture("texture/marble/height.png");
	unsigned int marbleroughness = loadTexture("texture/marble/roughness.png");

	unsigned int wallalbedo = loadTexture("texture/wall/basecolor.png");
	unsigned int wallnormal = loadTexture("texture/wall/normal.png");
	unsigned int wallheight = loadTexture("texture/wall/height.png");
	unsigned int wallroughness = loadTexture("texture/wall/roughness.png");
	unsigned int wallao = loadTexture("texture/wall/ao.png");

	unsigned int ceilingalbedo = loadTexture("texture/ceiling/basecolor.jpg");
	unsigned int ceilingnormal = loadTexture("texture/ceiling/normal.jpg");
	unsigned int ceilingheight = loadTexture("texture/ceiling/height.png");
	unsigned int ceilingroughness = loadTexture("texture/ceiling/roughness.jpg");
	unsigned int ceilingao = loadTexture("texture/ceiling/ao.jpg");

	unsigned int tilesalbedo = loadTexture("texture/tiles/basecolor.jpg");
	unsigned int tilesnormal = loadTexture("texture/tiles/normal.jpg");
	unsigned int tilesheight = loadTexture("texture/tiles/height.png");
	unsigned int tilesroughness = loadTexture("texture/tiles/roughness.jpg");
	unsigned int tilesao = loadTexture("texture/tiles/ao.jpg");
